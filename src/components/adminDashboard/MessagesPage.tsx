...
interface Message {
  ...
  text: string;
  time: string;
  sent: boolean; // true if sent by admin
}
...
const initialConversations: Conversation[] = [
  {
    ...
    messages: [
      {
        id: 1,
        text: "Hi admin, can you review our latest event submission?",
        time: "09:05",
        sent: false,
      },
      {
        id: 2,
        text: "Sure, I will check and get back to you soon.",
        time: "09:07",
        sent: true,
      },
      { id: 3, text: "Thank you!", time: "09:08", sent: false },
    ],
  },
  {
    id: "2",
    ...
    lastMessage: "Received, will review soon.",
    time: "1h ago",
    unread: 0,
    online: false,
    messages: [
      {
        id: 1,
        text: "Hello admin, our event is ready for approval.",
        time: "10:15",
        sent: false,
      },
      {
        id: 2,
        text: "Received, will review soon.",
        time: "10:17",
        sent: true,
      },
    ],
    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div>
        ...
        <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
          Chat with partners and event organizers
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg sm:rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-12 h-[500px] sm:h-[600px]">
          {/* LEFT SIDE — conversations list */}
          <div
            className={`lg:col-span-4 border-r border-gray-200 dark:border-gray-700 flex flex-col ${
                ...
                <button
                  ...
                  className={`w-full p-3 sm:p-4 flex items-center gap-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors border-b border-gray-100 dark:border-gray-700 ${
                    selectedConversation === conversation.id
                      ? "bg-[#27aae2]/10 dark:bg-[#27aae2]/20"
                      : ""
                  }`}
                >
